...
class LINK_URDF:
    ...
    def __init__(self,name,pos,size, color, color_name): #Henry added color
        ...
        self.visual    = VISUAL_URDF(self.origin , self.geometry, self.color, self.color_name) #henry adds self.color + self.color_name
